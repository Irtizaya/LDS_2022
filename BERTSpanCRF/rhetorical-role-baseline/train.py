...
class SentenceClassificationTrainer:
    ...
    def run_training_for_fold(self, fold_num, fold: Fold, initial_model=None, return_best_model=False):
        ...
        if initial_model is None:
            ...
            model = getattr(models, self.config["model"])(self.config, num_labels)
        else:
        ...
        #self.result_writer.log(f"Number of model parameters crf: {get_num_model_parameters(model.scrf)}")
